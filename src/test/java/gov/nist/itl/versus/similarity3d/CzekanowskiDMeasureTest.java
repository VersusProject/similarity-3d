 ...
 * CzekanowskiD Test
 */
public class CzekanowskiDMeasureTest extends junit.framework.TestCase
{
	...
	public CzekanowskiDMeasureTest(){}
	...
	public static SimilarityNumber dicom( String fileName1, String fileName2 ) throws Exception
	{
		...
		try {
			...
			CzekanowskiDMeasure m 		= new CzekanowskiDMeasure();
			
				if ( m == null )
					throw new SWIndependenceException("failed to create CzekanowskiDMeasure object for measure");
			...
			String rString = fileName1 + SEP + fileName2 + SEP + "DicomImageObjectAdapter" + SEP + "VoxelHistogramDescriptor" + SEP + "CzekanowskiDMeasure" + SEP + result.getValue() ;
			...
			String rString = "";
			if ( result != null ) 
				rString = fileName1 + SEP + fileName2 + SEP + "DicomImageObjectAdapter" + SEP + "VoxelHistogramDescriptor" + SEP + "CzekanowskiDMeasure" + SEP + result.getValue() ;
			else 
				rString = fileName1 + SEP + fileName2 + SEP + "DicomImageObjectAdapter" + SEP + "VoxelHistogramDescriptor" + SEP + "CzekanowskiDMeasure" + SEP + "null" ;
...
////////////////
	...
	public static SimilarityNumber dicomDir( String fileDir1, String fileDir2 ) throws Exception
	{
		...
		try {
			...
			String rString = fileDir1 + SEP + fileDir2 + SEP + "DicomImageObjectAdapter" + SEP + "VoxelHistogramDescriptor" + SEP + "CzekanowskiDMeasure" + SEP + result.getValue() ;
			System.out.println ( rString );
			...
			String rString = "";
			if ( result != null ) 
				rString = fileDir1 + SEP + fileDir2 + SEP + "DicomImageObjectAdapter" + SEP + "VoxelHistogramDescriptor" + SEP + "CzekanowskiDMeasure" + SEP + result.getValue() ;
			else 
				rString = fileDir1 + SEP + fileDir2 + SEP + "DicomImageObjectAdapter" + SEP + "VoxelHistogramDescriptor" + SEP + "CzekanowskiDMeasure" + SEP + "null" ;
			throw new SingularityTreatmentException( "" + rString + ": Error [" + e.getMessage() + "]");			
		} 
...
////////////////
	...
	public static SimilarityNumber mesh( String fileName1, String fileName2 ) throws Exception
	{
		...
		try {
			...
			String rString = fileName1 + SEP + fileName2 + SEP + "OBJImageObjectAdapter" + SEP + "VoxelHistogramDescriptor" + SEP + "CzekanowskiDMeasure" + SEP + result.getValue() ;
			System.out.println ( rString );
			...
			String rString = "";
			if ( result != null ) 
				rString = fileName1 + SEP + fileName2 + SEP + "OBJImageObjectAdapter" + SEP + "VoxelHistogramDescriptor" + SEP + "CzekanowskiDMeasure" + SEP + result.getValue() ;
			else 
				rString = fileName1 + SEP + fileName2 + SEP + "OBJImageObjectAdapter" + SEP + "VoxelHistogramDescriptor" + SEP + "CzekanowskiDMeasure" + SEP + "null" ;
			throw new SingularityTreatmentException( "" + rString + ": Error [" + e.getMessage() + "]");			
		} 
...
////////////////
	...
	{
		org.junit.runner.JUnitCore.runClasses( CzekanowskiDMeasureTest.class );
	}
}