...
/**
 * KumarJohnsonDifference Test
 */
public class KumarJohnsonDifferenceMeasureTest extends junit.framework.TestCase
{
	...
	public KumarJohnsonDifferenceMeasureTest(){}
	...
	public static SimilarityNumber dicom( String fileName1, String fileName2 ) throws Exception
	{
		...
		try {
			...
			KumarJohnsonDifferenceMeasure m 		= new KumarJohnsonDifferenceMeasure();
			
				if ( m == null )
					throw new SWIndependenceException("failed to create KumarJohnsonDifferenceMeasure object for measure");
			...
			String rString = fileName1 + SEP + fileName2 + SEP + "DicomImageObjectAdapter" + SEP + "VoxelHistogramDescriptor" + SEP + "KumarJohnsonDifferenceMeasure" + SEP + result.getValue() ;
			...
			String rString = "";
			if ( result != null ) 
				rString = fileName1 + SEP + fileName2 + SEP + "DicomImageObjectAdapter" + SEP + "VoxelHistogramDescriptor" + SEP + "KumarJohnsonDifferenceMeasure" + SEP + result.getValue() ;
			else 
				rString = fileName1 + SEP + fileName2 + SEP + "DicomImageObjectAdapter" + SEP + "VoxelHistogramDescriptor" + SEP + "KumarJohnsonDifferenceMeasure" + SEP + "null" ;
...
////////////////
	...
	public static SimilarityNumber dicomDir( String fileDir1, String fileDir2 ) throws Exception
	{
		...
		try {
			...
			String rString = fileDir1 + SEP + fileDir2 + SEP + "DicomImageObjectAdapter" + SEP + "VoxelHistogramDescriptor" + SEP + "KumarJohnsonDifferenceMeasure" + SEP + result.getValue() ;
			System.out.println ( rString );
			...
			String rString = "";
			if ( result != null ) 
				rString = fileDir1 + SEP + fileDir2 + SEP + "DicomImageObjectAdapter" + SEP + "VoxelHistogramDescriptor" + SEP + "KumarJohnsonDifferenceMeasure" + SEP + result.getValue() ;
			else 
				rString = fileDir1 + SEP + fileDir2 + SEP + "DicomImageObjectAdapter" + SEP + "VoxelHistogramDescriptor" + SEP + "KumarJohnsonDifferenceMeasure" + SEP + "null" ;
			throw new SingularityTreatmentException( "" + rString + ": Error [" + e.getMessage() + "]");			
		} 
...
////////////////
	...
	public static SimilarityNumber mesh( String fileName1, String fileName2 ) throws Exception
	{
		...
		try {
			...
			String rString = fileName1 + SEP + fileName2 + SEP + "OBJImageObjectAdapter" + SEP + "VoxelHistogramDescriptor" + SEP + "KumarJohnsonDifferenceMeasure" + SEP + result.getValue() ;
			System.out.println ( rString );
			...
			String rString = "";
			if ( result != null ) 
				rString = fileName1 + SEP + fileName2 + SEP + "OBJImageObjectAdapter" + SEP + "VoxelHistogramDescriptor" + SEP + "KumarJohnsonDifferenceMeasure" + SEP + result.getValue() ;
			else 
				rString = fileName1 + SEP + fileName2 + SEP + "OBJImageObjectAdapter" + SEP + "VoxelHistogramDescriptor" + SEP + "KumarJohnsonDifferenceMeasure" + SEP + "null" ;
			throw new SingularityTreatmentException( "" + rString + ": Error [" + e.getMessage() + "]");			
		} 
...
////////////////
	...
	{
		org.junit.runner.JUnitCore.runClasses( KumarJohnsonDifferenceMeasureTest.class );
	}
}