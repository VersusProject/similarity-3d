...
import gov.nist.itl.versus.similarity3d.comparisons.measure.impl.TotalErrorRateEvaluationMeasure;
...
/**
 * TotalErrorRateEvaluation Test
 */
public class TotalErrorRateEvaluationMeasureTest extends junit.framework.TestCase
{
	...
	public TotalErrorRateEvaluationMeasureTest(){}
	...
	public static SimilarityNumber dicom( String fileName1, String fileName2 ) throws Exception
	{
		...
		try {
			...
			TotalErrorRateEvaluationMeasure m 		= new TotalErrorRateEvaluationMeasure();
			
				if ( m == null )
					throw new SWIndependenceException("failed to create TotalErrorRateEvaluationMeasure object for measure");
			...
			String rString = fileName1 + SEP + fileName2 + SEP + "DicomImageObjectAdapter" + SEP + "VoxelToArrayFeature" + SEP + "TotalErrorRateEvaluationMeasure" + SEP + result.getValue() ;
			...
			String rString = "";
			if ( result != null ) 
				rString = fileName1 + SEP + fileName2 + SEP + "DicomImageObjectAdapter" + SEP + "VoxelToArrayFeature" + SEP + "TotalErrorRateEvaluationMeasure" + SEP + result.getValue() ;
			else 
				rString = fileName1 + SEP + fileName2 + SEP + "DicomImageObjectAdapter" + SEP + "VoxelToArrayFeature" + SEP + "TotalErrorRateEvaluationMeasure" + SEP + "null" ;
...
////////////////
	...
	public static SimilarityNumber dicomDir( String fileDir1, String fileDir2 ) throws Exception
	{
		...
		try {
			...
			String rString = fileDir1 + SEP + fileDir2 + SEP + "DicomImageObjectAdapter" + SEP + "VoxelToArrayFeature" + SEP + "TotalErrorRateEvaluationMeasure" + SEP + result.getValue() ;
			System.out.println ( rString );
			...
			String rString = "";
			if ( result != null ) 
				rString = fileDir1 + SEP + fileDir2 + SEP + "DicomImageObjectAdapter" + SEP + "VoxelToArrayFeature" + SEP + "TotalErrorRateEvaluationMeasure" + SEP + result.getValue() ;
			else 
				rString = fileDir1 + SEP + fileDir2 + SEP + "DicomImageObjectAdapter" + SEP + "VoxelToArrayFeature" + SEP + "TotalErrorRateEvaluationMeasure" + SEP + "null" ;
			throw new SingularityTreatmentException( "" + rString + ": Error [" + e.getMessage() + "]");			
		} 
...
////////////////
	...
	public static SimilarityNumber mesh( String fileName1, String fileName2 ) throws Exception
	{
		...
		try {
			...
			String rString = fileName1 + SEP + fileName2 + SEP + "OBJImageObjectAdapter" + SEP + "VoxelToArrayFeature" + SEP + "TotalErrorRateEvaluationMeasure" + SEP + result.getValue() ;
			System.out.println ( rString );
			...
			String rString = "";
			if ( result != null ) 
				rString = fileName1 + SEP + fileName2 + SEP + "OBJImageObjectAdapter" + SEP + "VoxelToArrayFeature" + SEP + "TotalErrorRateEvaluationMeasure" + SEP + result.getValue() ;
			else 
				rString = fileName1 + SEP + fileName2 + SEP + "OBJImageObjectAdapter" + SEP + "VoxelToArrayFeature" + SEP + "TotalErrorRateEvaluationMeasure" + SEP + "null" ;
			throw new SingularityTreatmentException( "" + rString + ": Error [" + e.getMessage() + "]");			
		} 
...
////////////////
	...
	{
		org.junit.runner.JUnitCore.runClasses( TotalErrorRateEvaluationMeasureTest.class );
	}
}