...
public class SquaredChiSquaredMeasure implements Measure, HasCategory, HasHelp
{
	private MathOpsE ops = new MathOpsE();
		...
		public SimilarityNumber compare(VoxelHistogramDescriptor feature1, VoxelHistogramDescriptor feature2) throws Exception 
		{
					...
					Double measurement  = ops.histogram_measure_squared_chiSquared( normHist1, normHist2 );
		...
		public String getName() {
			return "Squared Chi-Squared";
		}

		@Override
		public Class getType() {
			return SquaredChiSquaredMeasure.class;
		}	
		...
		public InputStream getHelpZipped() {
			return HelpProvider.getHelpZipped(SquaredChiSquaredMeasure.class);
		}

		@Override
		public String getHelpSHA1() {
			return HelpProvider.getHelpSHA1(SquaredChiSquaredMeasure.class);
		}	
}