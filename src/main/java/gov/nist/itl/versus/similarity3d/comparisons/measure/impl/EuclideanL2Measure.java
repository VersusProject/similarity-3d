...
public class EuclideanL2Measure implements Measure, HasCategory //, HasHelp
{
	private MathOpsE ops = new MathOpsE();
		...
		public Class getType() {
			return EuclideanL2Measure.class;
		}	
	...
	/*
		...
		public InputStream getHelpZipped() {
			return HelpProvider.getHelpZipped(EuclideanL2Measure.class);
		}

		@Override
		public String getHelpSHA1() {
			return HelpProvider.getHelpSHA1(EuclideanL2Measure.class);
		}
	*/	
}