...
public class SquaredChordDMeasure implements Measure, HasCategory, HasHelp
{
	private MathOpsE ops = new MathOpsE();
		...
		public SimilarityNumber compare(VoxelHistogramDescriptor feature1, VoxelHistogramDescriptor feature2) throws Exception 
		{
					...
					Double measurement  = ops.histogram_measure_squared_chord( normHist1, normHist2 );
		...
		public Class getType() {
			return SquaredChordDMeasure.class;
		}	
		...
		public InputStream getHelpZipped() {
			return HelpProvider.getHelpZipped(SquaredChordDMeasure.class);
		}

		@Override
		public String getHelpSHA1() {
			return HelpProvider.getHelpSHA1(SquaredChordDMeasure.class);
		}
}