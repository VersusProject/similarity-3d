...
public class FidelityMeasure implements Measure, HasCategory, HasHelp
{
	private MathOpsE ops = new MathOpsE();
		...
		public SimilarityNumber compare(VoxelHistogramDescriptor feature1, VoxelHistogramDescriptor feature2) throws Exception 
		{
					...
					Double measurement  = ops.histogram_measure_fidelity( normHist1, normHist2 );
		...
		public InputStream getHelpZipped() {
			return HelpProvider.getHelpZipped(FidelityMeasure.class);
		}

		@Override
		public String getHelpSHA1() {
			return HelpProvider.getHelpSHA1(FidelityMeasure.class);
		}
}