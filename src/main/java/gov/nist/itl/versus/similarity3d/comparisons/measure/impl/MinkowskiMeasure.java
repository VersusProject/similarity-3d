...
public class MinkowskiMeasure implements Measure, HasCategory, HasHelp
{
	private MathOpsE ops = new MathOpsE();
		...
		public SimilarityNumber compare(VoxelHistogramDescriptor feature1, VoxelHistogramDescriptor feature2) throws Exception 
		{
					...
					Double measurement  = ops.histogram_measure_minkowski( normHist1, normHist2 );
		...
		public InputStream getHelpZipped() {
			return HelpProvider.getHelpZipped(MinkowskiMeasure.class);
		}

		@Override
		public String getHelpSHA1() {
			return HelpProvider.getHelpSHA1(MinkowskiMeasure.class);
		}
}