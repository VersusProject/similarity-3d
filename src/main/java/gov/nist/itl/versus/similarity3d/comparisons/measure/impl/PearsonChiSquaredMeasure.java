...
public class PearsonChiSquaredMeasure implements Measure, HasCategory, HasHelp
{
	private MathOpsE ops = new MathOpsE();
		...
		public SimilarityNumber compare(VoxelHistogramDescriptor feature1, VoxelHistogramDescriptor feature2) throws Exception 
		{
					...
					Double measurement  = ops.histogram_measure_pearson_chiSquared( normHist1, normHist2 );
		...
		public String getName() {
			return "Pearson Chi-Squared";
		}

		@Override
		public Class getType() {
			return PearsonChiSquaredMeasure.class;
		}	
		...
		public InputStream getHelpZipped() {
			return HelpProvider.getHelpZipped(PearsonChiSquaredMeasure.class);
		}

		@Override
		public String getHelpSHA1() {
			return HelpProvider.getHelpSHA1(PearsonChiSquaredMeasure.class);
		}
}