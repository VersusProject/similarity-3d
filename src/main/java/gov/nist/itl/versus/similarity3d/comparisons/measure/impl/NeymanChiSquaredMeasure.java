...
public class NeymanChiSquaredMeasure implements Measure, HasCategory //, HasHelp
{
	private MathOpsE ops = new MathOpsE();
		...
		public SimilarityNumber compare(VoxelHistogramDescriptor feature1, VoxelHistogramDescriptor feature2) throws Exception 
		{
					...
					Double measurement  = ops.histogram_measure_neyman_chiSquared( normHist1, normHist2 );
		...
		public String getName() {
			return "Neyman Chi-Squared";
		}

		@Override
		public Class getType() {
			return NeymanChiSquaredMeasure.class;
		}	
	...
	/*
		...
		public InputStream getHelpZipped() {
			return HelpProvider.getHelpZipped(NeymanChiSquaredMeasure.class);
		}

		@Override
		public String getHelpSHA1() {
			return HelpProvider.getHelpSHA1(NeymanChiSquaredMeasure.class);
		}
	*/	
}