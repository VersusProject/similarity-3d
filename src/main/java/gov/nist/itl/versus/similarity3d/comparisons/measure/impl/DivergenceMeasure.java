...
public class DivergenceMeasure implements Measure, HasCategory, HasHelp
{
	private MathOpsE ops = new MathOpsE();
		...
		public SimilarityNumber compare(VoxelHistogramDescriptor feature1, VoxelHistogramDescriptor feature2) throws Exception 
		{
					...
					Double measurement  = ops.histogram_measure_divergence( normHist1, normHist2 );
		...
		public Class getType() {
			return DivergenceMeasure.class;
		}	
		...
		public InputStream getHelpZipped() {
			return HelpProvider.getHelpZipped(DivergenceMeasure.class);
		}

		@Override
		public String getHelpSHA1() {
			return HelpProvider.getHelpSHA1(DivergenceMeasure.class);
		}
}