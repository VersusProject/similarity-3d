...
public class CityBlockL1Measure implements Measure, HasCategory //, HasHelp
{
	private MathOpsE ops = new MathOpsE();
		...
		public SimilarityNumber compare(VoxelHistogramDescriptor feature1, VoxelHistogramDescriptor feature2) throws Exception 
		{
					...
					Double measurement  = ops.histogram_measure_city_block( normHist1, normHist2 );
		...
		public String getName() {
			return "City Block L1";
		}

		@Override
		public Class getType() {
			return CityBlockL1Measure.class;
		}	
	...
	/*
		...
		public InputStream getHelpZipped() {
			return HelpProvider.getHelpZipped(CityBlockL1Measure.class);
		}

		@Override
		public String getHelpSHA1() {
			return HelpProvider.getHelpSHA1(CityBlockL1Measure.class);
		}
	*/	
}