...
public class KulczynskiSMeasure implements Measure, HasCategory, HasHelp
{
	private MathOpsE ops = new MathOpsE();
		...
		public SimilarityNumber compare(VoxelHistogramDescriptor feature1, VoxelHistogramDescriptor feature2) throws Exception 
		{
					...
					Double measurement  = ops.histogram_measure_kulczynski_s( normHist1, normHist2 );
		...
		public String getName() {
			return "Kulczynski Similarity";
		}

		@Override
		public Class getType() {
			return KulczynskiSMeasure.class;
		}	
		...
		public InputStream getHelpZipped() {
			return HelpProvider.getHelpZipped(KulczynskiSMeasure.class);
		}

		@Override
		public String getHelpSHA1() {
			return HelpProvider.getHelpSHA1(KulczynskiSMeasure.class);
		}	
}