...
public class AdjustedRandIndexMeasure implements Measure, HasCategory, HasHelp
{
	private MathOpsE ops = new MathOpsE();
		...
		public SimilarityNumber compare(VoxelToArrayFeature feature1, VoxelToArrayFeature feature2) throws Exception 
		{
			...
			Double measurement = ops.pixel_measure_ari_nD(va1, va2 );	
				if ( measurement == null ) 
		...
		public InputStream getHelpZipped() {
			return HelpProvider.getHelpZipped(AdjustedRandIndexMeasure.class);
		}

		@Override
		public String getHelpSHA1() {
			return HelpProvider.getHelpSHA1(AdjustedRandIndexMeasure.class);
		}
