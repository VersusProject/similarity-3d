...
public class MatusitaMeasure implements Measure, HasCategory, HasHelp
{
	private MathOpsE ops = new MathOpsE();
		...
		public SimilarityNumber compare(VoxelHistogramDescriptor feature1, VoxelHistogramDescriptor feature2) throws Exception 
		{
					...
					Double measurement  = ops.histogram_measure_matusita( normHist1, normHist2 );
		...
		public String getName() {
			return "Matusita Similarity";
		}

		@Override
		public Class getType() {
			return MatusitaMeasure.class;
		}	
		...
		public InputStream getHelpZipped() {
			return HelpProvider.getHelpZipped(MatusitaMeasure.class);
		}

		@Override
		public String getHelpSHA1() {
			return HelpProvider.getHelpSHA1(MatusitaMeasure.class);
		}	
}