...
public class SquaredEuclideanMeasure implements Measure, HasCategory, HasHelp
{
	private MathOpsE ops = new MathOpsE();
		...
		public SimilarityNumber compare(VoxelHistogramDescriptor feature1, VoxelHistogramDescriptor feature2) throws Exception 
		{
					...
					Double measurement  = ops.histogram_measure_squared_euclidean( normHist1, normHist2 );
		...
		public Class getType() {
			return SquaredEuclideanMeasure.class;
		}	
		...
		public InputStream getHelpZipped() {
			return HelpProvider.getHelpZipped(SquaredEuclideanMeasure.class);
		}

		@Override
		public String getHelpSHA1() {
			return HelpProvider.getHelpSHA1(SquaredEuclideanMeasure.class);
		}
}