...
public class MotykaDMeasure implements Measure, HasCategory //, HasHelp
{
	private MathOpsE ops = new MathOpsE();
		...
		public SimilarityNumber compare(VoxelHistogramDescriptor feature1, VoxelHistogramDescriptor feature2) throws Exception 
		{
					...
					Double measurement  = ops.histogram_measure_motyka_dMot( normHist1, normHist2 );
	...
	/*
		...
		public InputStream getHelpZipped() {
			return HelpProvider.getHelpZipped(MotykaDMeasure.class);
		}

		@Override
		public String getHelpSHA1() {
			return HelpProvider.getHelpSHA1(MotykaDMeasure.class);
		}
	*/	
}