...
public class KulczynskiMeasure implements Measure, HasCategory, HasHelp
{
	private MathOpsE ops = new MathOpsE();
		...
		public SimilarityNumber compare(VoxelHistogramDescriptor feature1, VoxelHistogramDescriptor feature2) throws Exception 
		{
					...
					Double measurement  = ops.histogram_measure_kulczynski( normHist1, normHist2 );
		...
		public String getName() {
			return "Kulczynski Distance";
		}

		@Override
		public Class getType() {
			return KulczynskiMeasure.class;
		}	
		...
		public InputStream getHelpZipped() {
			return HelpProvider.getHelpZipped(KulczynskiMeasure.class);
		}

		@Override
		public String getHelpSHA1() {
			return HelpProvider.getHelpSHA1(KulczynskiMeasure.class);
		}
}