...
public class KumarJohnsonDifferenceMeasure implements Measure, HasCategory, HasHelp
{
	private MathOpsE ops = new MathOpsE();
		...
		public SimilarityNumber compare(VoxelHistogramDescriptor feature1, VoxelHistogramDescriptor feature2) throws Exception 
		{
					...
					Double measurement  = ops.histogram_measure_kumar_johnson_difference( normHist1, normHist2 );
		...
		public String getName() {
			return "Kumar-Johnson";
		}

		@Override
		public Class getType() {
			return KumarJohnsonDifferenceMeasure.class;
		}	
		...
		public InputStream getHelpZipped() {
			return HelpProvider.getHelpZipped(KumarJohnsonDifferenceMeasure.class);
		}

		@Override
		public String getHelpSHA1() {
			return HelpProvider.getHelpSHA1(KumarJohnsonDifferenceMeasure.class);
		}	
}