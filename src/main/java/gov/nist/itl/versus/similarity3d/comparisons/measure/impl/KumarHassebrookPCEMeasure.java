...
public class KumarHassebrookPCEMeasure implements Measure, HasCategory //, HasHelp
{
	private MathOpsE ops = new MathOpsE();
		...
		public SimilarityNumber compare(VoxelHistogramDescriptor feature1, VoxelHistogramDescriptor feature2) throws Exception 
		{
					...
					Double measurement  = ops.histogram_measure_kumar_hassebrook_pce( normHist1, normHist2 );
		...
		public String getName() {
			return "Kumar-Hassebrook (PCE)";
		}

		@Override
		public Class getType() {
			return KumarHassebrookPCEMeasure.class;
		}	
	...
	/*
		...
		public InputStream getHelpZipped() {
			return HelpProvider.getHelpZipped(KumarHassebrookPCEMeasure.class);
		}

		@Override
		public String getHelpSHA1() {
			return HelpProvider.getHelpSHA1(KumarHassebrookPCEMeasure.class);
		}
	*/	
}