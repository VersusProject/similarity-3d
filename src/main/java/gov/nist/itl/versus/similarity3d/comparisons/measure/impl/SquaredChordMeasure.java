...
public class SquaredChordMeasure implements Measure, HasCategory, HasHelp
{
	private MathOpsE ops = new MathOpsE();
		...
		public SimilarityNumber compare(VoxelHistogramDescriptor feature1, VoxelHistogramDescriptor feature2) throws Exception 
		{
					...
					Double measurement  = ops.histogram_measure_squared_chord_Ssqc1( normHist1, normHist2 );
		...
		public String getName() {
			return "Squared Chord Similarity";
		}

		@Override
		public Class getType() {
			return SquaredChordMeasure.class;
		}	
		...
		public InputStream getHelpZipped() {
			return HelpProvider.getHelpZipped(SquaredChordMeasure.class);
		}

		@Override
		public String getHelpSHA1() {
			return HelpProvider.getHelpSHA1(SquaredChordMeasure.class);
		}
}