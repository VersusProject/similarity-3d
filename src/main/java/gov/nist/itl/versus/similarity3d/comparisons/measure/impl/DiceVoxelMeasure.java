...
public class DiceVoxelMeasure implements Measure, HasCategory //, HasHelp
{
	private MathOpsE ops = new MathOpsE();
		...
		public SimilarityNumber compare(VoxelToArrayFeature feature1, VoxelToArrayFeature feature2) throws Exception 
		{
			...
			Double measurement = ops.pixel_measure_dice_nD(va1, va2 );	
				if ( measurement == null ) 
		...
		public String getName() {
			return "Dice Voxel Measure";
		}

		@Override
		public Class getType() {
			return DiceVoxelMeasure.class;
		}	
	...
	/*
		...
		public InputStream getHelpZipped() {
			return HelpProvider.getHelpZipped(DiceVoxelMeasure.class);
		}

		@Override
		public String getHelpSHA1() {
			return HelpProvider.getHelpSHA1(DiceVoxelMeasure.class);
		}
	*/
}