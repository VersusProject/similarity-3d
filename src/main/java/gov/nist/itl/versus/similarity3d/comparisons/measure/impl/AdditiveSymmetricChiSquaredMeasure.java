...
public class AdditiveSymmetricChiSquaredMeasure implements Measure, HasCategory //, HasHelp
{
	private MathOpsE ops = new MathOpsE();
		...
		public SimilarityNumber compare(VoxelHistogramDescriptor feature1, VoxelHistogramDescriptor feature2) throws Exception 
		{
					...
					Double measurement  = ops.histogram_measure_additive_symmetric_chiSquared( normHist1, normHist2 );
		...
		public String getName() {
			return "Additive Symmetric Chi-Squared";
		}

		@Override
		public Class getType() {
			return AdditiveSymmetricChiSquaredMeasure.class;
		}	
	...
	/*
		...
		public InputStream getHelpZipped() {
			return HelpProvider.getHelpZipped(AdditiveSymmetricChiSquaredMeasure.class);
		}

		@Override
		public String getHelpSHA1() {
			return HelpProvider.getHelpSHA1(AdditiveSymmetricChiSquaredMeasure.class);
		}
	*/	
}